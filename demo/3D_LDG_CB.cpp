...
int main() {
    ...
    dle3Solver->outputVTKDataFile(write_path + filename0, 0);
    dle3Solver->outputVTKDataFile(write_path + filename1, 1);
    dle3Solver->outputVTKDataFile(write_path + filename2, 2);
